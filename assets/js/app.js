...
addEventOnElement(searchToggler, "click", toggleSearch);
    ...
    fetchData(url.currentWeather(lat, lon), (currentWeather) => {
        ...
        <h2 class="title-2 card-title">Now</h2>
            <div class="wrapper ">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" width="64" height="64" class="weather-icon" alt="${description}">
        ...
        card.innerHTML = `
            ...
            <div class="highlight-list">
                <div class="card card-sm highlight-card one">
                    ...
                    <span class="badge api-${aqi} label-${aqi}" title="${module.aqiText[aqi].message}">
                    ...
                    <div class="card-list">
                        ...
                        <div class="card-item">
                            ...
                            <div>
                                ...
                                <p class="title-1">
                                ${module.getTime(sunsetUnixUTC, timezone)}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        fetchData(url.forecast(lat, lon), function(forecast){
            ...
            windLi.innerHTML = `
                <div class="card card-sm slider-card">
                    <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                    <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="${description}" title="${description}" class="weather-icon" style="transform: rotate(${windDirection - 180}deg)">

                    <p class="body-3">${parseInt(module.mps_to_kmh(windSpeed))} <br/>km/h</p>
                </div>
            `;
